...
function Config:CreateMenu()
    ...
    DF:BuildStatusbarAuthorInfo(statusBar, " For <Muted>, ", "Meroe      "..version)
        ...
        local checkboxHelper = function (markerLabel, markerType)
            ...
            for i=8, 1, -1 do
                local a = {
                    ...
                    set = function(self, fixedparam, value)
                        pocketMeroe.SetSetting(markerType, i)
                    end,
                    name = "  ",
                }
    ...
    do --do-do-do-do-do baby shark    
        ...
        DF:BuildMenu(markingConfigFrame, optionsTable, 10, -70, tabFrameHeight, false, options_text_template, options_dropdown_template, options_switch_template, true, options_slider_template, options_button_template, profileCallback)
        ...
        if (not pocketMeroeScrollPanel) then
            ...
            markingScroll:SetPoint("topleft", markingConfigFrame, "topleft", 5, -110)
            ...
            local createLine = function(self, index)
                ...
                markerType:SetPoint("right", line, "right", -26, 0)
            ...
            if (npcInfo ~= nil) then
                ...
                if helpers.markersEnabled(aura) then
                    if helpers.clearModifierIsPressed then
                        helpers.markersRemoveUnit(aura, unitId)
                        return
                    end
...
function pocketMeroe:initMarks ()
    ...
    helpers.markersRemoveUnit = function(aura, unitId)
        helpers.markersClearUnit(unitId)
