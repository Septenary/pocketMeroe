...
local default_config = {
	profile = {
		...
		markersCustom = { -- [mobID] = customMarks, priority, instanceShortcode,monsterType,unitName
			[15391] = {{8,7,6,5,4,3,2,1}, '','AQ20','Ads','Buru Egg'},
			[15392] = {{4,}, '','AQ20','Ads','Captian Qeez'},--strategy
			[15389] = {{4,}, '','AQ20','Ads','Captian Tuubid'},--strategy
			[15390] = {{4,}, '','AQ20','Ads','Captian Drenn'},--strategy
			[15386] = {{4,}, '','AQ20','Ads','Captian Xurrem'},--strategy
			[15388] = {{4,}, '','AQ20','Ads','Major Yeggeth'},--strategy
			[15385] = {{4,}, '','AQ20','Ads','Major Pakkon'},--strategy
			[15341] = {{4,}, '','AQ20','Ads','Colonel Zerran'},--strategy
			[15514] = {{4,}, '','AQ20','Boss','General Rajaxx'},--strategy
			...
			[12420] = {{8,7,6,5,4,3,2,1}, '','BWL','Ads','Blackwing Mage'},
			[11671] = {{8,7,}, '','MC','Trash','Core Hound'},
			[12076] = {{8,7,}, '','MC','Trash','Lava Elemental'},
			[12100] = {{6,5,}, '','MC','Trash','Lava Reaver'},
			[11659] = {{8,7,6,5,4,3,2,1}, '','MC','Trash','Molten Destroyer'},
			[11658] = {{8,7,6,5,4,3,2,1}, '','MC','Trash','Molten Giant'},
			[12118] = {{1,}, '','MC','Boss','Lucifron'},
			[12119] = {{8,7,6,5,}, '','MC','Ads','Flamewaker Protector'},
			[11982] = {{1,}, '','MC','Boss','Magmadar'},
			[12099] = {{1,}, '','MC','Boss','Garr'},
			[12056] = {{1,}, '','MC','Trash','Firesworn'},
			[12264] = {{4,}, '','MC','Boss','Baron Geddon'},--ppl like to mark the bomb as different things
			[11988] = {{8,}, '','MC','Boss','Shazzrah'},
			[11672] = {{4,3,}, '','MC','Trash','Core Rager'},--ads on golemagg
			[11662] = {{7,6,}, '','MC','Trash','Flamewaker Priest'},
			[11663] = {{4,3,2,1,}, '','MC','Trash','Flamewaker Healer'},
			[15981] = {{8,7,6,5,4,1,}, '','NAXX','Trash','Naxxramas Acolyte'},
			[16506] = {{4,3,2,1,}, '','NAXX','Trash','Naxxramas Worshipper'},
			[15974] = {{7,6,5,4,3,2,1,}, '','NAXX','Trash','Dread Creeper'},
			[16452] = {{8,7,1,}, '','NAXX','Trash','Necro Knight Guardian'},--holy shit these mobs hit hard!
			[16017] = {{8,7,6,5,4,}, '','NAXX','Trash','Patchwork Golem'},--these cleave! omg! chain cleave! 360!
			[16021] = {{8,1,}, '','NAXX','Trash','Living Monstrosity'},
			[16020] = {{7,6,5,4,3,2,1,}, '','NAXX','Trash','Mad Scientist'},--Living Monstrosity packs
			[16447] = {{8,7,5,4,3,}, '','NAXX','Trash','Plagued Ghoul'},
			...
			[14750] = {{8,7,6,5,}, '','ZG','Trash','Gurubashi Bat Rider'},
			[14883] = {{8,7,6,5,}, '','ZG','Trash','Voodoo Slave'},
			[11830] = {{8,7,}, '','ZG','Trash','Hakkari Priest'},
			[11353] = {{1,2,3,4,}, '','ZG','Trash','Gurubashi Blood Drinker'},
		}
